...
function themesflat_import_files() {
    return array(
        array(
            ...
            'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the MailChimp form.', 'dreamhome' ),
            'preview_url'                => esc_url('https://dreamhomewp.themesflat.com/'),
        ),
    );
}
