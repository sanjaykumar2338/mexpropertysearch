        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 header-top">
                        ...
                        <div class="header-ct-left">
                            ...
                            <?php if ( $header_infor_phone_show_email == 1 ) :?>
                                <div class="phone-header-box email">
                                    ...
                                    <?php endif; ?>
                                    <div class="inner">
                                        <?php echo wp_kses($header_info_email, themesflat_kses_allowed_html()); ?>
                                        <h3><?php echo esc_html($header_info_email_email_title); ?></h3>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <?php if( $header_search_box == 1 || $header_infor_phone == 1 || $header_socials == 1 || $header_button == 1): ?>
                        ...
                        <?php if ( $header_button == 1 ) :?>
                            <a href="<?php echo esc_html($header_button_url); ?>" class="tf-btn <?php if(!is_user_logged_in()) echo 'display-pop-login'; ?>"><?php echo wp_kses($header_button_text, themesflat_kses_allowed_html()); ?><span></span></a> 
                        <?php endif;?>
                                </div>
                    <?php endif; ?>
                    <div class="btn-menu">
                ...
                <div class="col-md-12 header-bottom">
                    ...
                    <?php if( $header_socials == 1 || $header_search_box == 1): ?>
                        <div class="header-ct-right">
