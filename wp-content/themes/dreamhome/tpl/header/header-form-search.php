...
?>
<header id="header" class="header header-search <?php echo themesflat_get_opt_elementor('extra_classes_header'); ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="header-ct-center">
                            <div class="inner-center">
                                <?php if (class_exists('Widget_Login_Menu')): ?>
                                    <?php do_action( 'popup_filter_form' ); ?>
                                <?php else: ?>
                    ...
                    <?php if( $header_search_box == 1 || $header_infor_phone == 1 || $header_socials == 1 || $header_button == 1): ?>
                        ...
                        <?php endif; ?>
                        <button class="button input-group-text tf-search-more-btn btn-popup-filter" style="display:none" data-toggle="collapse" aria-expanded="false"><i class="icon-dreamhome-filter"></i></button>
