...
if (!class_exists('Admin_Plugin_Options')) {
    class Admin_Plugin_Options {
         ...
         * @var string
         */
        private $opt_name = 'tfre' . '_options';
        ...
        private $page_slug = 'tfre' . '_options';
        ...
        function tfre_init_plugin_options() {
            if (!class_exists('Redux')) {
                return;
            }
            $this->menu_title = esc_html__('TF Real Estate Options', 'tf-real-estate');
            $this->page_title = esc_html__('ThemesFlat Real Estate Options', 'tf-real-estate');
            $this->tfre_setting_args_plugin_options();
            $this->tfre_setting_sections_plugin_options();
         ...
         */
        function tfre_setting_args_plugin_options() {
        ...
        function tfre_setting_sections_plugin_options() {
            $sections = array(
                'general-options',
                'setup-page-options',
                'property-options',
                'custom-additional-fields-options',
                'user-options',
                'package-options',
                'payment-options',
                'invoice-options',                
                ...
                'archive-agent-options',
                'agency-listing-options',
            );
            ...
            foreach ( $sections as $section ) {
                $sections_path[ $section ] = TF_PLUGIN_PATH . '/admin/resource/options/' . $section . '.php';
            }
    
            $sections_path = apply_filters( 'tfre_redux_sections', $sections_path );
            ...
            foreach ( $sections_path as $key => $file ) {
                ...
                if ( file_exists( $file ) ) {
                    ...
                    $options = apply_filters( "tfre_redux_sections_{$key}", $options );
