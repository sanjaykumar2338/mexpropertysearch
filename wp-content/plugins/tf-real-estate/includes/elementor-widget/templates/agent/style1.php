		...
		<div class="featured-post">
			...
			<div class="content">
				...
				<?php if ( $settings['show_contact'] == 'yes' ) : ?>
					<div class="contact">
						<a href="tel:<?php echo esc_attr( $agent_phone_number ); ?>" class="phone"><i class="icon-dreamhome-incoming-call"></i></a>
						<a href="mailto:<?php echo esc_attr( $agent_email ); ?>" class="mail"><i class="fas fa-envelope"></i></a>
					</div>
				<?php endif; ?>
			</div>
		</div>
