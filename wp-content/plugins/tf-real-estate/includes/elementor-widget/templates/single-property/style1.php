		...
		<div class="featured-single-property">
			<?php if ( is_array( $property_gallery ) && count( $property_gallery ) > 1 ) : ?>
				<div class="tfre-property-info">
					<div class="single-property-image-main-1 owl-carousel manual tfre-carousel-manual">
						<?php
				...
				<div class="content-wrapper owl-carousel owl-loaded">
					<div class="content">
						<div class="top">
								...
								<div class="contact-agent">
									...
									<?php if ( $settings['show_action'] == 'yes' ) : ?>
										<div class="agent-contact-information">
											<a class="agent-phone" href="<?php echo 'tel:' . esc_url( $user_phone_number ); ?>"
												target="_blank">
												<i class="icon-dreamhome-phone-cal"></i>
											</a>
											<a class="agent-mail" href="<?php echo 'mailto:' . esc_attr( $user_email ); ?>"
												target="_blank">
					...
					<div class="owl-nav">
						<button type="button" role="presentation" id="prev-slide" class="owl-prev"><span
								aria-label="Previous"><i class="icon-dreamhome-arrow-left"></i></span></button>
						<button type="button" role="presentation" id="next-slide" class="owl-next"><span
								aria-label="Next"><i class="icon-dreamhome-arrow-right"></i></span></button>
					</div>
				</div>
			<?php else : ?>
