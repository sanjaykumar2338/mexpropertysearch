...
$css_class_field      = 'col-xs-12';
$css_class_half_field = 'col-xs-6';
				...
				<div class="form-search-inner">
					...
					<div data-href="<?php echo esc_url( $advanced_search_url ) ?>" class="search-properties-form">
						<div class="tf-search-form">
							<div class="tf-search-form-top desktop in-sidebar">
										...
										if ( $property_status ) :
											foreach ( $property_status as $status ) : ?>
												<button type="button" data-value="<?php echo esc_attr( $status->slug ) ?>"
													class="btn-status-filter <?php if ( $value_status == $status->slug )
								...
								<?php endif; ?>
								<?php render_search_fields( $search_fields, false, $css_class_field ); ?>
							</div>
							<div class="tf-search-form-top tf-search-form-top-action desktop">
								<div
								...
								<div class="<?php echo esc_attr( $css_class_field ); ?> form-group submit-search-form pull-right">
									<a href="javascript:void(0)" class="btn-clear-all"><?php esc_html_e('Clear All', 'tf-real-estate'); ?></a>
								</div>
							</div>
							...
							<div class="tf-search-form-bottom mobile">
								<div class="row">
									<?php
									$search_fields_bottom = array_filter( $search_fields, function ($k) {
										return $k != 'keyword'; }, ARRAY_FILTER_USE_KEY );
