...
<?php tfre_get_option('archive_property_search_form') == 'enable' && do_action('property_advanced_search_form'); ?>

<div class="tfre_message"></div>

<div class="cards-container <?php echo esc_attr(tfre_get_option('map_position')); ?> row">
	...
	<div class="col-md-6 <?php echo esc_attr(tfre_get_option('hide_map_mobile') == 'y' ? 'hide-map-mobile' : ''); ?>">
