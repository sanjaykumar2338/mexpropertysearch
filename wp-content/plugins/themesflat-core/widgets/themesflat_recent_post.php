...
class Themesflat_Recent_Post extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_recent_post',
            esc_html__( 'Themesflat - Recent News', 'themesflat-core' ),
            array(
                'classname'   => 'widget-recent-news',
                'description' => esc_html__( 'Recent News.', 'themesflat-core' )
            )
        );
    }
		...
		<?php if ( $flat_post->have_posts() ) : ?>
			<?php while ( $flat_post->have_posts() ) : $flat_post->the_post(); ?>
				<li class="clearfix">
                    ...
                    <div class="text">     
                        <?php if ( $show_date ) : ?>
                        <div class="post-date date updated"><i class="meta-icon icon-dreamhome-date" aria-hidden="true"></i> <?php the_time( 'F d, Y' ); ?></div>
                        <?php endif; ?>                              
